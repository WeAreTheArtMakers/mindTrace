    ...
    <div className="mt-8 pt-6 border-t border-neutral-200 dark:border-neutral-800">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a
          ...
          className="inline-flex items-center justify-center w-10 h-10 bg-neutral-100 dark:bg-neutral-800 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors"
        ...
        {'share' in navigator && (
          <button
            onClick={shareNative}
            className="inline-flex items-center justify-center w-10 h-10 bg-neutral-100 dark:bg-neutral-800 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors sm:hidden"
            aria-label="Share"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
